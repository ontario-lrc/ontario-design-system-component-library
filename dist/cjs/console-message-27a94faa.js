...
class ConsoleMessageClass {
	...
	printMessage(consoleType = exports.ConsoleType.Warning) {
		...
		switch (consoleType) {
			case exports.ConsoleType.Error:
				console.error.apply(null, messageArray);
				break;
			case exports.ConsoleType.Info:
				console.info.apply(null, messageArray);
				break;
			case exports.ConsoleType.Warning:
...
exports.ConsoleMessageClass = ConsoleMessageClass;

//# sourceMappingURL=console-message-27a94faa.js.map
