		...
		return index.h(
			...
			index.h(
				...
				index.h(
					...
					index.h('use', { key: 'd6828c955c7c78cdf87251929a1161d568c7f91b', href: '#B2' }),
					index.h('path', {
					...
					index.h('use', { key: '3baf26f66cfef267d5181bd221bec5d7c57d7086', href: '#B2', y: '2.036' }),
					index.h('path', {
...
exports.ontario_icon_interac_fr_alt = OntarioIconInteracFrAlt;

//# sourceMappingURL=ontario-icon-interac-fr-alt.cjs.entry.js.map
