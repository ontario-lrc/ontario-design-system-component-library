...
const OntarioIconLinkedinAltStyle0 = ontarioIconCss;
...
const OntarioIconLinkedinAlt = class {
	...
	render() {
		return index.h(
			'div',
			{
				key: 'bf01b602e678abeea69e1c26aeb3b39f550c046d',
			...
			index.h(
				'svg',
				{
					key: '24094d328aa09eab39fd5e8e21386e4285aa56d4',
					class: 'svg-icon',
				...
				index.h('path', {
					key: 'c740793d2ab66e5d71dcae03b36195456fb7b6a6',
...
OntarioIconLinkedinAlt.style = OntarioIconLinkedinAltStyle0;

exports.ontario_icon_linkedin_alt = OntarioIconLinkedinAlt;

//# sourceMappingURL=ontario-icon-linkedin-alt.cjs.entry.js.map
