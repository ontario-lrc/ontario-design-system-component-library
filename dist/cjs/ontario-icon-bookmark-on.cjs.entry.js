	...
	render() {
		return index.h(
			...
			index.h(
				...
				index.h('path', { d: 'M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2z' }),
			),
		);
	}
	static get watchers() {
...
OntarioIconBookmarkOn.style = ontarioIconCss;

exports.ontario_icon_bookmark_on = OntarioIconBookmarkOn;
