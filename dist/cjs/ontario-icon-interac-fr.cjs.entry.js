...
const OntarioIconInteracFr = class {
	...
	render() {
		return index.h(
			...
			index.h(
				'svg',
				{ class: 'svg-icon', role: 'img', xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24', id: 'interac-fr' },
				index.h('path', {
					'fill-rule': 'evenodd',
...
OntarioIconInteracFr.style = ontarioIconCss;

exports.ontario_icon_interac_fr = OntarioIconInteracFr;
