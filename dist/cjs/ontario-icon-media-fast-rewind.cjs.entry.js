	...
	render() {
		return index.h(
			...
			index.h(
				...
				index.h('path', { d: 'M11 18V6l-8.5 6 8.5 6zm.5-6l8.5 6V6l-8.5 6z' }),
			),
		);
	}
	static get watchers() {
...
OntarioIconMediaFastRewind.style = ontarioIconCss;

exports.ontario_icon_media_fast_rewind = OntarioIconMediaFastRewind;
