	...
	render() {
		return h(
			...
			h(
				...
				h('path', { key: '9824ed09819841897039685cf0bbc488e28a734c', d: 'M6 19h4V5H6v14zm8-14v14h4V5h-4z' }),
			),
		);
	}
	static get watchers() {
...
export { OntarioIconMediaPause as ontario_icon_media_pause };

//# sourceMappingURL=ontario-icon-media-pause.entry.js.map
