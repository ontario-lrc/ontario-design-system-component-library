...
function queryNonceMetaTagContent(doc) {
	var _a, _b, _c;
	return (_c =
		(_b = (_a = doc.head) === null || _a === void 0 ? void 0 : _a.querySelector('meta[name="csp-nonce"]')) === null ||
		_b === void 0
			? void 0
...
const getScopeId = (cmp, mode) =>
	'sc-' + (mode && cmp.$flags$ & 32 /* CMP_FLAGS.hasMode */ ? cmp.$tagName$ + '-' + mode : cmp.$tagName$);
/**
			...
			if (
				...
				Object.defineProperty(prototype, memberName, {
					value(...args) {
						...
						return (_a = ref === null || ref === void 0 ? void 0 : ref.$onInstancePromise$) === null || _a === void 0
							? void 0
							: _a.then(() => {
									var _a;
...
//# sourceMappingURL=index-603026f7.js.map
