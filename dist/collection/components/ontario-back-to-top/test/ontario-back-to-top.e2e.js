...
describe('ontario-back-to-top', () => {
	...
	it('should be visible when the window is scrolled down beyond 200px', async () => {
		...
		expect(styles === null || styles === void 0 ? void 0 : styles.visibility).toBe('visible');
	});
	it('should trigger the window to scroll back to the top of the page when clicked', async () => {
		...
		const pageDetails = await page.evaluate(() => {
			...
			return {
				...
				element: (_a = component.shadowRoot) === null || _a === void 0 ? void 0 : _a.firstElementChild,
				elementClassName:
					(_c = (_b = component.shadowRoot) === null || _b === void 0 ? void 0 : _b.firstElementChild) === null ||
					_c === void 0
						? void 0
						: _c.className,
			};
...
//# sourceMappingURL=ontario-back-to-top.e2e.js.map
