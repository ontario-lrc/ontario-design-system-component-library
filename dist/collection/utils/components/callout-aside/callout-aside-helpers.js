...
import { HeadingLevel, HighlightColours } from './callout-aside.interface';
export const isValidHighlightColour = (colour) => HighlightColours.includes(colour);
export const isValidHeadingLevel = (level) => HeadingLevel.includes(level);
