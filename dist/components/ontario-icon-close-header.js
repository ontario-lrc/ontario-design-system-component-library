...
const OntarioIconCloseHeader$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconCloseHeader extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconCloseHeaderStyle0;
		}
	},
	[
		1,
		'ontario-icon-close-header',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-close-header'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-close-header':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconCloseHeader$1);
				}
				break;
		}
	});
...
const OntarioIconCloseHeader = OntarioIconCloseHeader$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconCloseHeader, defineCustomElement };

//# sourceMappingURL=ontario-icon-close-header.js.map
