...
const OntarioIconCameraStyle0 = ontarioIconCss;

const OntarioIconCamera$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconCamera extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconCameraStyle0;
		}
	},
	[
		1,
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-camera'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-camera':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconCamera$1);
				}
				break;
		}
	});
...
const OntarioIconCamera = OntarioIconCamera$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconCamera, defineCustomElement };
