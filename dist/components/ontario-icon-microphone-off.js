...
const OntarioIconMicrophoneOff$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconMicrophoneOff extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconMicrophoneOffStyle0;
		}
	},
	[
		1,
		'ontario-icon-microphone-off',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-microphone-off'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-microphone-off':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconMicrophoneOff$1);
				}
				break;
		}
	});
...
const OntarioIconMicrophoneOff = OntarioIconMicrophoneOff$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconMicrophoneOff, defineCustomElement };

//# sourceMappingURL=ontario-icon-microphone-off.js.map
