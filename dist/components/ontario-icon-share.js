...
const OntarioIconShare$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconShare extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-share'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-share':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconShare$1);
				}
				break;
		}
	});
...
const OntarioIconShare = OntarioIconShare$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconShare, defineCustomElement };

//# sourceMappingURL=ontario-icon-share.js.map
