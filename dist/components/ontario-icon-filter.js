...
const OntarioIconFilterStyle0 = ontarioIconCss;

const OntarioIconFilter$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconFilter extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconFilterStyle0;
		}
	},
	[
		1,
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-filter'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-filter':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconFilter$1);
				}
				break;
		}
	});
...
const OntarioIconFilter = OntarioIconFilter$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconFilter, defineCustomElement };
