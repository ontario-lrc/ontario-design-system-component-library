...
const OntarioIconLinkedinStyle0 = ontarioIconCss;

const OntarioIconLinkedin$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconLinkedin extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconLinkedinStyle0;
		}
	},
	[
		1,
		'ontario-icon-linkedin',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-linkedin'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-linkedin':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconLinkedin$1);
				}
				break;
		}
	});
...
const OntarioIconLinkedin = OntarioIconLinkedin$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconLinkedin, defineCustomElement };

//# sourceMappingURL=ontario-icon-linkedin.js.map
