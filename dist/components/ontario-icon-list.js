...
const OntarioIconList$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconList extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-list'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-list':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconList$1);
				}
				break;
		}
	});
...
const OntarioIconList = OntarioIconList$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconList, defineCustomElement };

//# sourceMappingURL=ontario-icon-list.js.map
