...
const OntarioIconRemoveStyle0 = ontarioIconCss;

const OntarioIconRemove$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconRemove extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconRemoveStyle0;
		}
	},
	[
		1,
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-remove'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-remove':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconRemove$1);
				}
				break;
		}
	});
...
const OntarioIconRemove = OntarioIconRemove$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconRemove, defineCustomElement };
