...
const OntarioIconSearchWhite$1 = /*@__PURE__*/ proxyCustomElement(
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-search-white'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-search-white':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconSearchWhite$1);
				}
				break;
		}
	});
...
const OntarioIconSearchWhite = OntarioIconSearchWhite$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconSearchWhite, defineCustomElement };
