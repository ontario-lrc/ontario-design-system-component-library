...
const OntarioIconInteracFr$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconInteracFr extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconInteracFrStyle0;
		}
	},
	[
		1,
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-interac-fr'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-interac-fr':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconInteracFr$1);
				}
				break;
		}
	});
...
const OntarioIconInteracFr = OntarioIconInteracFr$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconInteracFr, defineCustomElement };

//# sourceMappingURL=ontario-icon-interac-fr.js.map
