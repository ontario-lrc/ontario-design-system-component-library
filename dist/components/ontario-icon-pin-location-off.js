...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-pin-location-off'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-pin-location-off':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconPinLocationOff$1);
				}
				break;
		}
	});
...
const OntarioIconPinLocationOff = OntarioIconPinLocationOff$1;
