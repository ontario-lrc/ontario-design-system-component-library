...
const OntarioIconCloseStyle0 = ontarioIconCss;

const OntarioIconClose$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconClose extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-close'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-close':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconClose$1);
				}
				break;
		}
	});
...
const OntarioIconClose = OntarioIconClose$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconClose, defineCustomElement };
