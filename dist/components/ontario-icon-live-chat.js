...
const OntarioIconLiveChat$1 = /*@__PURE__*/ proxyCustomElement(
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-live-chat'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-live-chat':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconLiveChat$1);
				}
				break;
		}
	});
...
const OntarioIconLiveChat = OntarioIconLiveChat$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconLiveChat, defineCustomElement };
