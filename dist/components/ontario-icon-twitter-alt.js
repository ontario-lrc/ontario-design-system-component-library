...
const OntarioIconTwitterAlt$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconTwitterAlt extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconTwitterAltStyle0;
		}
	},
	[
		1,
		'ontario-icon-twitter-alt',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-twitter-alt'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-twitter-alt':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconTwitterAlt$1);
				}
				break;
		}
	});
...
const OntarioIconTwitterAlt = OntarioIconTwitterAlt$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconTwitterAlt, defineCustomElement };
