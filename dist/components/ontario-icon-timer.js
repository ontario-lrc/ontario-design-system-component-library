...
const OntarioIconTimer$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconTimer extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-timer'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-timer':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconTimer$1);
				}
				break;
		}
	});
...
const OntarioIconTimer = OntarioIconTimer$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconTimer, defineCustomElement };

//# sourceMappingURL=ontario-icon-timer.js.map
