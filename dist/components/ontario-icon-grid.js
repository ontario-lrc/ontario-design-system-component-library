...
const OntarioIconGrid$1 = /*@__PURE__*/ proxyCustomElement(
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-grid'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-grid':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconGrid$1);
				}
				break;
		}
	});
...
const OntarioIconGrid = OntarioIconGrid$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconGrid, defineCustomElement };
