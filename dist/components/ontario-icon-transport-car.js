...
const OntarioIconTransportCar$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconTransportCar extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconTransportCarStyle0;
		}
	},
	[
		1,
		'ontario-icon-transport-car',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-transport-car'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-transport-car':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconTransportCar$1);
				}
				break;
		}
	});
...
const OntarioIconTransportCar = OntarioIconTransportCar$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconTransportCar, defineCustomElement };

//# sourceMappingURL=ontario-icon-transport-car.js.map
