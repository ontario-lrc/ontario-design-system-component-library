...
const OntarioIconSentiment2Style0 = ontarioIconCss;

const OntarioIconSentiment2$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconSentiment2 extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconSentiment2Style0;
		}
	},
	[
		1,
		'ontario-icon-sentiment-2',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-sentiment-2'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-sentiment-2':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconSentiment2$1);
				}
				break;
		}
	});
...
const OntarioIconSentiment2 = OntarioIconSentiment2$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconSentiment2, defineCustomElement };

//# sourceMappingURL=ontario-icon-sentiment-2.js.map
