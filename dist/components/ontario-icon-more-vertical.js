...
const OntarioIconMoreVerticalStyle0 = ontarioIconCss;

const OntarioIconMoreVertical$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconMoreVertical extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconMoreVerticalStyle0;
		}
	},
	[
		1,
		'ontario-icon-more-vertical',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-more-vertical'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-more-vertical':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconMoreVertical$1);
				}
				break;
		}
	});
...
const OntarioIconMoreVertical = OntarioIconMoreVertical$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconMoreVertical, defineCustomElement };
