...
const OntarioIconReplay$1 = /*@__PURE__*/ proxyCustomElement(
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-replay'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-replay':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconReplay$1);
				}
				break;
		}
	});
...
const OntarioIconReplay = OntarioIconReplay$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconReplay, defineCustomElement };
