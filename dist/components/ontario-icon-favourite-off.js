...
const OntarioIconFavouriteOffStyle0 = ontarioIconCss;

const OntarioIconFavouriteOff$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconFavouriteOff extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconFavouriteOffStyle0;
		}
	},
	[
		1,
		'ontario-icon-favourite-off',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-favourite-off'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-favourite-off':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconFavouriteOff$1);
				}
				break;
		}
	});
...
const OntarioIconFavouriteOff = OntarioIconFavouriteOff$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconFavouriteOff, defineCustomElement };
