...
const OntarioIconYoutube$1 = /*@__PURE__*/ proxyCustomElement(
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-youtube'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-youtube':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconYoutube$1);
				}
				break;
		}
	});
...
const OntarioIconYoutube = OntarioIconYoutube$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconYoutube, defineCustomElement };
