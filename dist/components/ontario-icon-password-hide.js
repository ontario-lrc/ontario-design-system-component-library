...
const OntarioIconPasswordHide$1 = /*@__PURE__*/ proxyCustomElement(
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-password-hide'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-password-hide':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconPasswordHide$1);
				}
				break;
		}
	});
...
const OntarioIconPasswordHide = OntarioIconPasswordHide$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconPasswordHide, defineCustomElement };
