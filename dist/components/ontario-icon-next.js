...
const OntarioIconNextStyle0 = ontarioIconCss;

const OntarioIconNext$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconNext extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-next'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-next':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconNext$1);
				}
				break;
		}
	});
...
const OntarioIconNext = OntarioIconNext$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconNext, defineCustomElement };
