...
const OntarioIconInteracEnAlt$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconInteracEnAlt extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
			...
			return h(
				...
				h(
					...
					h(
						...
						h('use', { key: 'bdc39602e53ba3ae9e2a986339cc20a0f94be479', href: '#B' }),
						h('path', {
						...
						h('use', { key: 'e66c1c664e96503f861e754c5f0aad1259e14d02', href: '#B', x: '3.748' }),
						h('path', {
		...
		static get style() {
			return OntarioIconInteracEnAltStyle0;
		}
	},
	[
		1,
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-interac-en-alt'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-interac-en-alt':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconInteracEnAlt$1);
				}
				break;
		}
	});
...
const OntarioIconInteracEnAlt = OntarioIconInteracEnAlt$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconInteracEnAlt, defineCustomElement };

//# sourceMappingURL=ontario-icon-interac-en-alt.js.map
