...
const OntarioIconCloud$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconCloud extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-cloud'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-cloud':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconCloud$1);
				}
				break;
		}
	});
...
const OntarioIconCloud = OntarioIconCloud$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconCloud, defineCustomElement };
