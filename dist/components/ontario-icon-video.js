...
const OntarioIconVideoStyle0 = ontarioIconCss;

const OntarioIconVideo$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconVideo extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-video'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-video':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconVideo$1);
				}
				break;
		}
	});
...
const OntarioIconVideo = OntarioIconVideo$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconVideo, defineCustomElement };

//# sourceMappingURL=ontario-icon-video.js.map
