...
const OntarioIconSave$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconSave extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-save'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-save':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconSave$1);
				}
				break;
		}
	});
...
const OntarioIconSave = OntarioIconSave$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconSave, defineCustomElement };

//# sourceMappingURL=ontario-icon-save.js.map
