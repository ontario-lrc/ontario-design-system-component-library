...
const OntarioIconInteracFrAlt$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconInteracFrAlt extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconInteracFrAltStyle0;
		}
	},
	[
		1,
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-interac-fr-alt'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-interac-fr-alt':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconInteracFrAlt$1);
				}
				break;
		}
	});
...
const OntarioIconInteracFrAlt = OntarioIconInteracFrAlt$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconInteracFrAlt, defineCustomElement };

//# sourceMappingURL=ontario-icon-interac-fr-alt.js.map
