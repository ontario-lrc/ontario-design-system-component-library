...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-bookmark-on'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-bookmark-on':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconBookmarkOn$1);
				}
				break;
		}
	});
...
const OntarioIconBookmarkOn = OntarioIconBookmarkOn$1;
