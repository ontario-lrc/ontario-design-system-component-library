...
const OntarioIconEditStyle0 = ontarioIconCss;

const OntarioIconEdit$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconEdit extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-edit'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-edit':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconEdit$1);
				}
				break;
		}
	});
...
const OntarioIconEdit = OntarioIconEdit$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconEdit, defineCustomElement };
