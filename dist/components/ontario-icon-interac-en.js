...
const OntarioIconInteracEnStyle0 = ontarioIconCss;

const OntarioIconInteracEn$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconInteracEn extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
			...
			return h(
				...
				h(
					...
					h(
						...
						h('use', { key: '4cf608cde7661ec2637820ad45178c7aa9aa81e3', href: '#B3' }),
						h('use', { key: 'efed2f1d77f99f3489e10885cd6538253da199b6', href: '#B3', y: '1.014' }),
						h('path', {
		...
		static get style() {
			return OntarioIconInteracEnStyle0;
		}
	},
	[
		1,
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-interac-en'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-interac-en':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconInteracEn$1);
				}
				break;
		}
	});
...
const OntarioIconInteracEn = OntarioIconInteracEn$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconInteracEn, defineCustomElement };

//# sourceMappingURL=ontario-icon-interac-en.js.map
