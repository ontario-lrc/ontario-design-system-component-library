...
const OntarioIconSentiment4$1 = /*@__PURE__*/ proxyCustomElement(
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-sentiment-4'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-sentiment-4':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconSentiment4$1);
				}
				break;
		}
	});
...
const OntarioIconSentiment4 = OntarioIconSentiment4$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconSentiment4, defineCustomElement };
