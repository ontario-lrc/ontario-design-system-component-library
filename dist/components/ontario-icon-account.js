...
const OntarioIconAccountStyle0 = ontarioIconCss;

const OntarioIconAccount$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconAccount extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconAccountStyle0;
		}
	},
	[
		1,
		'ontario-icon-account',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-account'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-account':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconAccount$1);
				}
				break;
		}
	});
...
const OntarioIconAccount = OntarioIconAccount$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconAccount, defineCustomElement };
