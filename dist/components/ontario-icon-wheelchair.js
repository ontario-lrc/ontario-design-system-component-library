...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-wheelchair'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-wheelchair':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconWheelchair$1);
				}
				break;
		}
	});
...
const OntarioIconWheelchair = OntarioIconWheelchair$1;
