import { h, Fragment, proxyCustomElement, HTMLElement, getAssetPath } from '@stencil/core/internal/client';
...
const OntarioFooter$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioFooter extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
