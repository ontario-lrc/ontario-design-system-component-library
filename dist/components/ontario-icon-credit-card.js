...
const OntarioIconCreditCardStyle0 = ontarioIconCss;

const OntarioIconCreditCard$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconCreditCard extends HTMLElement {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
		...
		static get style() {
			return OntarioIconCreditCardStyle0;
		}
	},
	[
		1,
		'ontario-icon-credit-card',
		{
...
function defineCustomElement$1() {
	...
	const components = ['ontario-icon-credit-card'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-icon-credit-card':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioIconCreditCard$1);
				}
				break;
		}
	});
...
const OntarioIconCreditCard = OntarioIconCreditCard$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioIconCreditCard, defineCustomElement };

//# sourceMappingURL=ontario-icon-credit-card.js.map
