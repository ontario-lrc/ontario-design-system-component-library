import { r as i, h as o, g as t } from './p-e870d905.js';
import { C as s } from './p-b5fbefe0.js';
const l = class {
	constructor(o) {
		i(this, o), (this.iconWidth = 24), (this.iconWidthState = void 0);
	}
	validateWidth() {
	...
	render() {
		return o(
			...
			o(
				...
				o('path', { d: 'M23 5H1v13.974h22V5z', fill: '#fff' }),
				o('path', { d: 'M22.633 16.703H1.367v1.905h21.267v-1.905z', fill: '#fcb316' }),
				o('path', {
